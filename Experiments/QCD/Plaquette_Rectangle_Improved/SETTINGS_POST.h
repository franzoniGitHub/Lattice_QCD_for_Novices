...
//*************** PARAMETERS **********************//
std::string filename =
    "DataOutput_8x8x8x8_100NofSU3_10Ncf_improved.dat";  ///< Name of the input file
bool smeared = false;                                   ///< Option to perform smearings
int Nsmearings = 4;                                     ///< Number of smearings
