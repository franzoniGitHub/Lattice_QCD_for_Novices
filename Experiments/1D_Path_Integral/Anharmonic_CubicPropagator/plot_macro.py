...
#Generate the exact constant line deltaE = 1.933
dE_exact=[1.933,1.933]
...
plt.plot(t_exact,dE_exact, color='red', marker='None', label="Exact asymptotic $\Delta E=1.933$")
plt.legend(loc='lower left')
#Set title and x - y axis labels for the Axes
plt.title("1D Anharmonic Oscillator, Cubic Propagator", fontsize=18)
plt.axis([-0.2,(n_data-1)*a+0.2,-2.,4.])
plt.xlabel('$t$')
